...
def mouse_motion(event):
    global mouse_x, mouse_y
    mouse_x, mouse_y = event.x, event.y
    canvas.coords(follower_id, mouse_x-30, mouse_y-20)
...
follower_image = PhotoImage(file='myxaboy.png')
follower_id = canvas.create_image(0, 0, image=follower_image, anchor='nw')
